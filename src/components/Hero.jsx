            ...
            <div className="px-4 py-12 mx-auto max-w-5xl sm:px-20 md:px-40 lg:px-24 lg:py-24">
                <div className="flex flex-wrap items-center mx-auto max-w-7xl">
                    ...
                    <div className="flex flex-col items-start mt-12 mb-16 text-left lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0">
                        <span className="mb-8 text-xs font-bold tracking-widest text-blue-600 dark:text-white uppercase">
                            {" "}
                            I am{" "}
                        </span>
                        <h1 className="fontC  mb-8 text-4xl font-bold leading-none dark:text-white tracking-tighter md:text-7xl lg:text-5xl">
                            Pratik Rai
                        </h1>
                        <p className="mb-8 text-xl leading-relaxed text-left dark:text-white  sfont ">
                            <TypeAnimation
                                sequence={[
                        ...
                        <div className="flex dark:text-white  flex-wrap w-full mt-2 -mx-4 text-left">
